...
# Introdução:
    ...
    - Dicas valiosas de estudo para complementar a carreira do Dev, para ajudar na sua carreira
    - Tópicos
        Inglês
        Tecnologias
...
- Habilidades
  ...
  - Escutar PodCast: SpoTfy, Youtube
  - Treinar a Escrita
  - Praticar Fala
...
pagina de exemplo de comentarios no commits: https://platform.uno/docs/articles/uno-development/git-conventional-commits.html

kubernetes
https://github.com/FIAP/POSTECH_SOAT_KUBERNETES_2/tree/main/aula_8/secrets

Simulados Certificação
...
Inglês (Planejamento de estudo) - https://todaylead.com/dicas-de-ingles/
